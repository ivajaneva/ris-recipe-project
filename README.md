...
- **Frontend:** React.js, uporabniški vmesnik
- **Backend:** Java 17+, Spring Boot, REST API za delo z recepti
- **Baza podatkov:** MySQL, data.sql - začetni podatki ob zagonu
- **Docker:** za enostavno namestitev in zagon aplikacije
- **Maven:** za upravljanje backend odvisnosti
- **Node.js & npm:** za upravljanje frontend odvisnosti
